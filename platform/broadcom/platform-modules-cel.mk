...
CEL_MYSTONE_PLATFORM_MODULE_VERSION = 1.0
...
export CEL_MYSTONE_PLATFORM_MODULE_VERSION
...
CEL_MYSTONE_PLATFORM_MODULE = platform-modules-mystone_$(CEL_MYSTONE_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_MYSTONE_PLATFORM_MODULE)_PLATFORM = x86_64-cel_mystone-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_MYSTONE_PLATFORM_MODULE)))
