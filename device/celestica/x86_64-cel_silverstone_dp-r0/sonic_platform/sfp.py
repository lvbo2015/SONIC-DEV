...
class Sfp(SfpBase):
    ...
    def __init__(self, sfp_index):
        ...
        self.dom_dict_keys = ['rx_los', 'tx_fault', 'reset_status', 'lp_mode', 'tx_disable', 'tx_disable_channel', 'temperature', 'voltage',
    ...
    def __get_sfp_info(self):
        ...
        elif self.port_num >= OSFP_PORT_START and self.port_num <= OSFP_PORT_END:
            sfp_type = OSFP_TYPE
            port_name = "QSFPDD" + str(self.port_num - OSFP_PORT_START + 1)
    ...
    def get_reset_status(self):
        ...
        reg_status = self._api_helper.read_one_line_file(
            "/".join([PORT_INFO_PATH, self.port_name, "qsfp_resetL"]))
    ...
    def get_lpmode(self):
        ...
        """
        reg_file = self._api_helper.read_txt_file(
            "/".join([PORT_INFO_PATH, self.port_name, "qsfp_lpmode"]))

        # Read status
        content = reg_file.rstrip()
