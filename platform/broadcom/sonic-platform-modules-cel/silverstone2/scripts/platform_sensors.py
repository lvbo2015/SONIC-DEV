...
def read_temperature_sensors(ipmi_sdr_elist):
    ...
    sensor_list = [
        ('TEMP_FAN_U52',        'Fan Tray Middle Inlet Temp'),
        ('TEMP_FAN_U17',        'Fan Tray Right Intel Temp'),
        ...
        ('SW_U71_Temp1',        'Power IC IR35215 Internal Temp'),
        ('SW_U78_Temp1',        'Power IC IR35215 Internal Temp'),
        ('SW_U71_Temp2',        'Power IC IR35215 Internal Temp'),
    ]
