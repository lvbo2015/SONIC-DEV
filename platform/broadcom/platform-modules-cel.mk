...
CEL_QUESTONE2BD_PLATFORM_MODULE_VERSION = 1.0
...
export CEL_QUESTONE2BD_PLATFORM_MODULE_VERSION
...
CEL_QUESTONE2BD_PLATFORM_MODULE = platform-modules-questone2bd_$(CEL_QUESTONE2BD_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_QUESTONE2BD_PLATFORM_MODULE)_PLATFORM = x86_64-cel_questone2bd-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_QUESTONE2BD_PLATFORM_MODULE)))
